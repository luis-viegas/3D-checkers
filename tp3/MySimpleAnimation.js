class MySimpleAnimation{
    ...
    update(deltaTime){
        ...
        this.translation = [
            this.translateStart[0] + (this.translateEnd[0] - this.translateStart[0]) * ratio,
            this.translateStart[1] + (this.translateEnd[1] - this.translateStart[1]) * ratio,
            this.translateStart[2] + (this.translateEnd[2] - this.translateStart[2]) * ratio
        ]
