  ...
  updateGameState() {
    switch (this.state) {
      ...
      case gameState.Player1PickingDestination:
        this.scene.setPickEnabled(true);
        this.availableDestinations = this.board.getAvailableDestinations(this.selectedPiece);
        break;
      ...
      case gameState.Player1MovingPiece:
        this.scene.setPickEnabled(false);
        //Animate piece
        this.board.movePiece(this.selectedPiece, this.board.getTile(this.selectedPiece) , this.selectedDestination);
        if(this.pieceEaten != undefined){
          this.board.removePiece(this.pieceEaten.getTile());
          this.selectedPiece = this.board.getTileByCoords(this.selectedDestination.coords).getPiece()
          this.pieceEaten = undefined;
          this.availablePieces = undefined;
          this.availableDestinations = undefined;
          this.selectedDestination = undefined;
      ...
      case gameState.Player1PickingDestination:
        ...
        if (obj instanceof MyTile){
          ...
          if(this.availablePieces == undefined){
            if(!this.board.isPieceBetween(this.selectedPiece.getTile(), this.selectedDestination)){
              return;
            }
          }
          if(this.board.isPieceBetween(this.selectedPiece.getTile(), this.selectedDestination)){
            this.pieceEaten = this.board.getPieceBetween(this.selectedPiece.getTile(), this.selectedDestination);
          }
